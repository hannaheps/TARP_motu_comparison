...
permanova_benthic_situ_n15<-adonis2(tet_video_raw_meta_broad_sp_all ~ N.15_at_30m  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
...
permanova_benthic_situ_seabird_no_rare<-adonis2(tet_video_raw_meta_broad_sp ~ seabird_level  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
...
permanova_benthic_situ_n15_no_rare<-adonis2(tet_video_raw_meta_broad_sp ~ N.15_at_30m  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
...
#situ - full community---
#run analysis
permanova_benthic_situ_seabird<-adonis2(tet_situ_raw_meta_broad_sp_all ~ seabird_level  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
permanova_benthic_situ_seabird
#              Df SumOfSqs      R2      F Pr(>F)  
...
permanova_benthic_situ_n15<-adonis2(tet_situ_raw_meta_broad_sp_all ~ N.15_at_30m  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
permanova_benthic_situ_n15
#              Df SumOfSqs      R2      F Pr(>F)  
...
permanova_benthic_situ_seabird_no_rare<-adonis2(tet_situ_raw_meta_broad_sp ~ seabird_level  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
permanova_benthic_situ_seabird_no_rare
#              Df SumOfSqs      R2      F Pr(>F)  
...
permanova_benthic_situ_n15_no_rare<-adonis2(tet_situ_raw_meta_broad_sp ~ N.15_at_30m  + protection,  data = benthic.vid.seabirds.levels.algae, by = "margin", permutations = 999)
permanova_benthic_situ_n15_no_rare
#            Df SumOfSqs      R2      F Pr(>F)
...
#add in distance to shore or (inshore/offshore distance)-----
...
#pavement/turf seabird----
pave.vid.lmm<-lmer(pavement_percent_cover~seabird_level+wind.exposure + (1|site.name), data = benthic.vid.seabirds.levels.algae)
summary(pave.vid.lmm)
Anova(pave.vid.lmm) #NOTHING SIGNIFICANT****

pave.situ.lmm<-lmer(pavement_percent_cover~seabird_level+wind.exposure + (1|site.name), data = benthic.situ.seabirds.levels.algae)
summary(pave.situ.lmm)
Anova(pave.situ.lmm) #NOTHING SIGNIFICANT****


#pavement/turf algae n15----
...
pave.situ.algae.lmm<-lmer(pavement_percent_cover~N.15_at_30m+wind.exposure + (1|site.name), data = benthic.situ.seabirds.levels.algae)
...
#Sand seabird----
sand.vid.lmm<-lmer(sand_percent_cover~seabird_level+wind.exposure + (1|site.name), data = benthic.vid.seabirds.levels.algae)
summary(sand.vid.lmm)
Anova(sand.vid.lmm) #NOTHING SIGNIFICANT****

sand.situ.lmm<-lmer(sand_percent_cover~seabird_level+wind.exposure + (1|site.name), data = benthic.situ.seabirds.levels.algae)
summary(sand.situ.lmm)
Anova(sand.situ.lmm) #seabird level marginal****
plot_summs(sand.situ.lmm) #looks like mid and high seabird have more sand than low seabird.



#sand algae n15----
sand.vid.algae.lmm<-lmer(sand_percent_cover~N.15_at_30m+wind.exposure + (1|site.name), data = benthic.vid.seabirds.levels.algae)
summary(sand.vid.algae.lmm)
Anova(sand.vid.algae.lmm) #NOTHING SIGNIFICANT****

sand.situ.algae.lmm<-lmer(sand_percent_cover~N.15_at_30m+wind.exposure + (1|site.name), data = benthic.situ.seabirds.levels.algae)
summary(sand.situ.algae.lmm)
Anova(sand.situ.algae.lmm) #NOTHING SIGNIFICANT****
...
qqnorm(resid(hard_coral_vid.lmm))
qqline(resid(hard_coral_vid.lmm))
#marginal effect of seabird level:
...
#now no effect of seabird level
...
##add macroalgae:
plot_dat_macro_vid<-emmip(macro.vid.algae.lmm,  ~N.15_at_30m, at = mylist_n15, CIs = TRUE, plotit=FALSE)
plot_dat_macro_vid
...
library(glmmTMB)
hard_coral_vid.lmm.beta<-glmmTMB(hard_coral_percent_cover~seabird_level+wind.exposure + (1|site.name), family=beta_family(link="logit"), data = benthic.vid.seabirds.levels.algae.beta)
...
hc_vid_response_plot_beta<-
  ggplot(data = plot_data_hc_vid_beta, aes(x = seabird_level, y = yvar))+
#  geom_point(pch = 4,  position = position_dodge(.3))+
  geom_pointrange(aes(ymin = LCL, ymax = UCL), alpha = .3, linewidth = 2, size = 0,  position = position_dodge(.1)) + #,  position = position_dodge(.3)
 # geom_point(data = fishn15.seabirds.cond.r, 
           #  aes(y = n15, x = seabird_level), size = 2.5, alpha = .5,  position = position_dodge(.3))+ 
