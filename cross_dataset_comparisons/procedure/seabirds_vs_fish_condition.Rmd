...
#run regular lm's, because now only one site per motu (so random effects don't make much sense):
```{r}
...
fish_n15_response_int_plot<-
  ggplot(data = plot_data_n15, aes(x = seabird_level, y = yvar, color = species, fill = species))+
