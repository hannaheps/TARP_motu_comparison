...
fish.seabirds.levels.algae.w.nmds.autoT<-
 left_join(fish.seabirds.levels.algae.w.nmds.norotate.autoT,
           nmds_fish_site_scores_rotate.autoT, 
             by = c("site.name", "transect")) %>%
...
site.mid.autoT <- fish.seabirds.levels.algae.w.nmds.autoT[fish.seabirds.levels.algae.w.nmds.autoT$seabird_level == "mid", ][chull(fish.seabirds.levels.algae.w.nmds.autoT[fish.seabirds.levels.algae.w.nmds.autoT$seabird_level == 
    "mid", c("NMDS1", "NMDS2")]), ]  
...
##get arrows:
ord.fit.fish.autoT<-envfit(nmds_fish_dens_autoT ~ N.15_at_30m +protection + structural_complexity_0to5, data = fish.seabirds.levels.algae.w.nmds.autoT, na.rm=TRUE)
...
fish_dens_nmds_plot.autoT<-
ggplot() + 
  geom_text(data=fish_spp.sc.autoT,aes(x=NMDS1,y=NMDS2,label=Species), alpha = .5) +  # add the species labels - 
...
##save plot  
ggsave(fish_dens_nmds_plot.autoT, file = "../output/seabird-fish/fish_dens_nmds_plot.autoT.jpg",
       width = 7, height = 5)
...
##get arrows:
ord.fit.fish.rotate.autoT <-envfit(nmds_fish_dens_autoT.rotate  ~ N.15_at_30m +protection + structural_complexity_0to5, data = fish.seabirds.levels.algae.w.nmds.autoT, na.rm=TRUE)
...
levels(fish.seabirds.levels.algae.w.nmds.autoT$seabird_level)


fish_dens_nmds_plot_rotate.autoT<-
ggplot() + 
...
##save plot  
ggsave(fish_dens_nmds_plot_rotate.autoT , file = "../output/seabird-fish/fish_dens_nmds_plot_rotate.autoT.jpg",
       width = 7, height = 5)
...
ggplot() + 
  geom_text(data=fish_spp.sc.rotate.autoT ,aes(x=NMDS1,y=NMDS2 ,label=species2), alpha = .5, hjust = "inward") +  # add the species labels - 
  geom_point(data=fish.seabirds.levels.algae.w.nmds.autoT ,aes(x=NMDS1.rotate,y=NMDS2.rotate,colour=N.15_at_30m, fill = N.15_at_30m), stat="identity", size=5, alpha = .9) +
...
#save plot
ggsave(fish_dens_nmds_plot_rotate.autoT.newcolors, file = "../output/seabird-benthic/fish_nmds_plot_rotate_new_colours.jpg",
    width = 7, height = 5)
