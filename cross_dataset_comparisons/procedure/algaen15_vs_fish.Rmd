...
#look at ordfit - seabird level and offshore algae n15
...
vif(fish_bio_full_mod_algae_log_poly) #all good
...
anova(fish_bio_full_mod_algae_log_poly, fish_bio_full_mod_algae_log, fish_bio_full_mod_algae_log_no_algae) #no algae is better

#intercept only:
fish_bio_full_mod_algae_log_int <-lmer(log(sum_fish_biomass)~   (1|site.name), data = fish_comb_dat_levels_algae) #
anova(fish_bio_full_mod_algae_log_poly, fish_bio_full_mod_algae_log, fish_bio_full_mod_algae_log_no_algae, fish_bio_full_mod_algae_log_int) #intercept only same as no algae

#probably don't go down that root, just compare linear versus non-linear....
