...
##save outputs----
write.csv(cor.mat_sb_fishn15, "../output/seabirds_fish_n15_corrmatrix.csv")
write.csv(cor.mat_sb_fishn15_byspp, "../output/seabirds_fish_n15_by_species_corrmatrix.csv")


#chunk 2
pdf(file = "../output/seabirds_fishn15_corr_plot.pdf")
...
#chunk 3
pdf(file = "../output/seabirds_fishn15_by_species_corr_plot.pdf")
...
ggsave(emm_plot_sb_n15, file = "../output/seabirds_fishn15_interaction_plot.pdf",
       width = 7, height = 5)
...
ggsave(fish_n15_biplots, file = "../output/fishn15_biplot.pdf",
       width = 9, height = 6)
