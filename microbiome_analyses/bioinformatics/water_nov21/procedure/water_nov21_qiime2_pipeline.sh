...
qiime tools import \
  ...
  --input-path ../../TARP_motu_comparison/microbiome_analyses/bioinformatics/water_nov21/input/water_nov21_manifest.txt \
  --output-path output/bioinformatics/water-nov21-paired-end-demux.qza \
  --input-format PairedEndFastqManifestPhred33V2
  
qiime demux summarize \
  --i-data output/bioinformatics/water-nov21-paired-end-demux.qza  \
  --o-visualization ../../TARP_motu_comparison/microbiome_analyses/bioinformatics/water_nov21/output/water-nov21-paired-end-demux.qzv
...
qiime cutadapt trim-paired \
  --i-demultiplexed-sequences output/bioinformatics/water-nov21-paired-end-demux.qza \
  --p-front-f GTGYCAGCMGCCGCGGTAA \
  --p-front-r GGACTACNVGGGTWTCTAAT \
  --o-trimmed-sequences output/bioinformatics/water-nov21-paired-end-demux-trim.qza

qiime demux summarize \
  --i-data output/bioinformatics/water-nov21-paired-end-demux-trim.qza  \
  --o-visualization ../../TARP_motu_comparison/microbiome_analyses/bioinformatics/water_nov21/output/water-nov21-paired-end-demux-trim.qzv

##Here we can now change to the current directory in which these files are located for the rest of the pipeline
cd ~/Documents/OSUDocs/Projects/French_Polynesia/Tetiaroa/Island_Survey/TARP_motu_comparison/microbiome_analyses/bioinformatics/water_nov21/procedure
