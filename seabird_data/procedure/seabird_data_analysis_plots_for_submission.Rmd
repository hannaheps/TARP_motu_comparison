...
#ggsave(filename = "../outputs/Figure2_seabird_boxplot.jpg",    plot = seabird_rat_log_int_plot_box,    width = 7,  height = 5,    units = "in",   dpi = 500)
#ggsave(filename = "../outputs/Figure2_seabird_boxplot.pdf",    plot = seabird_rat_log_int_plot_box,    width = 7,  height = 5,    units = "in",   dpi = 500)


```


##make and save stacked plots of seabird proportions by motu----
```{r}
