...
sb_br_bio_space_mod_full<-lmer(breeding_biomass~ rat.eradication.status * protection * spatial_scale + (1|motu), 
                          data = seabird_focal_all_meta_long)
#doesn't work
...
seabird_focal_all_meta_for_corr<-as.data.frame(seabird_focal_all_meta[,7:21])
